...
export default function Sidebar() {
  ...
  return (
    <div
      className={`bg-white/90 backdrop-blur p-3 transition-all duration-300 ease-in-out flex flex-col items-center shadow-md border border-gray-200 rounded-2xl h-full
        ...
        {menuItems.map((item, idx) => {
          ...
          return (
            <li key={idx}>
              ...
              >
                <span
                  className={`mr-1  text-xl transition-transform duration-300 group-hover:scale-110 ${
